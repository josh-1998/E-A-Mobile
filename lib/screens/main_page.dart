  ...
  Widget build(BuildContext context) {
    ...
    return Provider(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            pages[Provider.of<PageNumber>(context,).pageNumber],
          EAthleteNavBar(
        ...
        showUpdatePicker = false;
          ...
          button2Function: (){
            showMaterialModalBottomSheet(context: context, builder: (builder, scrollController){
              return BlocProvider(
                  create: (context) => SessionBloc(Provider.of<UserRepository>(context, listen: false)),
                  child: Padding(
                    padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
                    child: SafeArea(child: SingleChildScrollView(child: SessionUpdateScreen())),
                  ));
            });
            setState(() {
